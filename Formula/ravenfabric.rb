class Ravenfabric < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/egkristi/RavenFabric-Published/releases/download/v1.0.0-rc.2/ravenfabric-darwin-arm64-cli"
      sha256 "4134c70db4aaf508c7065067a6baa59104f5926bc73040d8e399d73cc84212f7"
    else
      url "https://github.com/egkristi/RavenFabric-Published/releases/download/v1.0.0-rc.2/ravenfabric-darwin-amd64-cli"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/egkristi/RavenFabric-Published/releases/download/v1.0.0-rc.2/ravenfabric-linux-arm64-musl-cli"
      sha256 "9b10902f39ff66eddfc216311719e26eca4873ef62ee65179430ff422cc0e5e1"
    else
      url "https://github.com/egkristi/RavenFabric-Published/releases/download/v1.0.0-rc.2/ravenfabric-linux-amd64-musl-cli"
